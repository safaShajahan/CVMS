...
if(!isset($_SESSION['UserName'])){
  ...
  $email=$_POST['email'];
     ...
     $query=mysqli_query($con, "update tblemp set EmpName='$AName', MobileNumber ='$mobno', Email= '$email' where UserName='$name'");
    if ($query) {
...
?>
                                               <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="adminname" name="name" value="<?php  echo $row['EmpName'];?>" class="form-control" required="">
