...
$query=mysqli_query($con,"select username from tbllogin where username='$adminid' and   password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbllogin set password='$newpassword' where username='$adminid'");
