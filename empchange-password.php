...
$query=mysqli_query($con,"select UserName from tblemp where UserName='$adminid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tblemp set Password='$newpassword' where Username='$adminid'");
...
<body class="animsition">
    <div class="page-wrapper">
        <!-- HEADER MOBILE-->
        <?php include_once('includes/empsidebar.php');?>
        <!-- END HEADER MOBILE-->
        ...
        <div class="page-container">
            <!-- HEADER DESKTOP-->
            <?php include_once('includes/empheader.php');?>
            <!-- HEADER DESKTOP-->
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Change</strong> User Password
                                    </div>
   ...
   <?php
$adminid=$_SESSION['UserName'];
$ret=mysqli_query($con,"select * from tblemp where UserName='$adminid'");
$cnt=1;
...
?>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="password" id="confirmpassword" name="confirmpassword" class="form-control" maxlength="20" value="" required="">
