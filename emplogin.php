...
<head>
    ...
    <!-- Title Page-->
    <title>CVMS Employee Login</title>
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="empvalidation.php" method="post" name="login">
                            ...
                            <!--  <button class="au-btn au-btn--block au-btn--green m-b-20" onclick="location.href='login.php'" type="button" >User sign in</button>  -->
